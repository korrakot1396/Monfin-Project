...
<div class = "w3-center">
<br>
<h1><img src="{{ url('/') }}/storage/images/icons/reserve.png" width="80" height="80" alt="puukao"> ข้อมูลการจองของ <b>{{ Auth::user()->username }}<b></h1>
</div>
@foreach ($details as $detail)
        ...
        <input type="submit" class="w3-right w3-button w3-indigo" value="สร้างช่องทางการชำระเงิน">
        </form>
