        ...
        <div class="col-md-8">
            <div class="card w3-teal">
                ...
                <div class="card-body w3-light-grey">
                        ...
                        <img src="/storage/images/users/admin.png" id="output" alt="Avatar" class="w3-left w3-circle w3-margin-right" width="80" height="80">
                        </div>
                        </center>
                        <br>
                        <br>
                        ...
                        <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="telephone" value="{{ old('telephone') }}" required autocomplete="telephone" autofocus>
                        ...
                        <label for="image" class="col-md-4 col-form-label text-md-right">Profile Upload</label>
